...
def extract_frustum_data(idx_filename, split, output_filename, viz=False,
    ...
    '''
    print(idx_filename)
    print(type(next(open(idx_filename))))
...
if __name__=='__main__':
    ...
    parser.add_argument('--gen_test', action='store_true', help='Generate test split frustum data with perturbed GT 2D boxes')
    ...
    if args.gen_test:
        extract_frustum_data_rgb_detection( \
            os.path.join(BASE_DIR, 'rgb_detections/rgb_detection_test.txt'),
            'testing',
            os.path.join(BASE_DIR, output_prefix + 'test_rgb_detection.pickle'),
            viz=False,
            type_whitelist=type_whitelist)
